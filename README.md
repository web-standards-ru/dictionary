...
При переводе зарубежных имён следует пользоваться правилами [практической транскрипции](https://ru.wikipedia.org/wiki/Категория:Практическая_транскрипция_с_русским_языком), принятыми для данного языка.
