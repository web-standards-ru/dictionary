...
**скринри́дер,** программное обеспечение, способное озвучивать информацию, отображенную на экране устройства. Является одним из видов вспомогательных технологий. Предназначен для зрячих пользователей, которым проще воспринимать информацию на слух, для людей с дислексией и слепых или слабовидящих., напр. _they use screen reader to navigate the web — для навигации в сети они используют скринридер,_ _screen reader will say «image cat» — cкринридер прочитает «изображение кошка»_
