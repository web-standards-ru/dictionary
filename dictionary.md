...
**драг-н-дроп, перетаскивание,** способ взаимодействия с интерфейсом, в котором пользователь перемещает объекты из одного места в другое в рамках страницы или снаружи, напр. _we can sort this list via drag-and-drop — мы можем отсортировать этот список с помощью драг-н-дропа_ или _to upload a file drag and drop it here — чтобы загрузить файл, перетащите его сюда._
