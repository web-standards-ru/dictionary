...
**тротлинг,** искусственное ограничение выполнения той или иной задачи с определённым условием. Используется для ограничения скорости соединения сети и мощности CPU в DevTools, выполнения функции в JavaScript (например, при скролле) и т.п.
