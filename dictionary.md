...
**мелькание содержимого без стилей**, отображение страницы или её части стандартными стилями до загрузки внешнего CSS-файла
 ...
 - flash of faux text, FOFT — **мелькание синтезированного текста**, отображение стилей шрифта (курсива, жирного) изменённым браузером основным шрифтом до загрузки этих стилей
