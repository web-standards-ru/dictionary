...
**тротлинг,** введение искусственных ограничений, напр. для уменьшение частоты вызовов обработчиков событий в JS или скорости сети и мощности ЦП при тестировании.
