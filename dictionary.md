...
**интернационализация,** это адаптация содержимого продукта (сайта, приложения, документации и т.п.) под различные языковые и культурные особенности. Другими словами, это основа, на которой будет проводится [локализация](#localization,-l10n) на конкретный язык.
...
**локализация,** адаптация содержимого продукта (сайта, приложения, документации и т.п.) к языковым и культурным соответствиям определенного региона (страны).
