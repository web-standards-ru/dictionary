...
Точно так же, как [каскадные источники](#cascade-origin) обеспечивают баланс между стилями пользователя и разработчика, **каскадные слои** обеспечивают способ организации в рамках одного источника. Объявляются с помощью [директивы](#at-rule) `@layer`.
