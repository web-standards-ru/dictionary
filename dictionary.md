...
**куки,** небольшой фрагмент данных, отправляемый сервером на браузер пользователя, который тот может сохранить и отсылать обратно с новым запросом к данному серверу. В едиснтвенном числе - **кука**. Примеры склонений: _доступ к кукам, Директива Евросоюза о куках, сторонними куками, авторизационная кука_.
