...
**всплывающее окно, поповер,** элемент интерфейса, содержащий дополнительную информацию, появляющийся по триггеру вроде нажатия на кнопку или наведении курсора на элемент. Частный случай [попапа](#popup).
