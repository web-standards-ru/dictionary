...
**компоне́нт,** (м. р.) составная часть чего-либо. Напр. _app components_ — _компоненты приложения._
...
**выражение от контейнера,** механизм для задания стилей элементов, которые зависят от ширины контейнера.
