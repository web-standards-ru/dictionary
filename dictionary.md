...
1. прил. **разделяемый**, напр. _shared memory_ — _разделяемая память_
2. прил. **общий**, напр. _shared folder_ — _общая папка_, _shared access_ — _общий доступ_
...
- _web worker_ — _веб-воркер_
- _service worker_ — _сервис-воркер_
- _shared worker_ — _общий воркер_
...
- _paint worklet_ — _ворклет отрисовки_
- _compositor worklet_ — _ворклет композитинга_
- _layout worklet_ — _ворклет раскладки_
