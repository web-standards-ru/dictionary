...
**содержащий блок** - блок, относительно которого рассчитываются размеры и положения данного блока. Прибегая к упрощенным понятиям, содержащий блок - это родитель данного блока не по DOM, а по потоку документа. Например, если высота блока задана в процентах и он позиционирован абсолютно, то есть высота будет рассчитываться не относительно родителя родителя, а относительно ближайшего предка с не статическим позиционированием.
