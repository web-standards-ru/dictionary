...
Точно так же, как [каскадные источники](#cascade-origin) обеспечивают баланс между стилями пользователя и разработчика, **каскадные слои** обеспечивают способ организации структуры в рамках одного источника. Объявляются с помощью [директивы](#at-rule) `@layer`.

### cascade origin

**каскадные источники** - уровни, на которых возможно объявление стилей в css. Существует 8 уровней: самый высокий - transition-декларации, самый низкий - декларации user-агента.
