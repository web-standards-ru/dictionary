...
**реестр**, место для хранения данных. Например: пакетов.

- Docker registry – реестр для хранения Docker-репозиториев

- npm registry – реестр npm с JavaScript-пакетами, npm-репозиторий

- GitHub Package Registry – реестр пакетов GitHub
