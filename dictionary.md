...
**ресурс.** В широком смысле под ресурсами понимается всё, из чего состоит сайт (текстовые файлы, графика, видео, базы данных и т.д.). Часто употребляется в узком смысле «статический ресурс» (стили, скрипты, графика для оформления и т.п.), в противоположность динамическому [содержимому](https://github.com/web-standards-ru/dictionary/blob/master/dictionary.md#content).
