...
**интернационализация,** процесс создания и разработки продукта, который в последующем обеспечит безбарьерную локализацию приложения.
...
**локализация,** адаптация продукта и его документации к языковым соответствиям, культурным и другим требованиям целевого рынка или рынков (локалей).
