...
**интернационализация,** процесс проектирования и разработки интерфейса, позволяющий производить [локализацию](#localization-l10n) для различных регионов (различающихся по культуре или языку) без каких-либо технических изменений, напр., _при проектировании сайта Анна решила адаптировать его под множество различных культур, поэтому прежде чем приступить к работе, она детально изучила тему интернационализации._
...
**локализация,** процесс адаптации интерфейса под языковые и культурные соответствия определённого региона (страны, локали), напр., _первое, на что необходимо обратить внимание при внедрении локализации на сайте - отображение формата даты и времени._
