...
**расширениe**, позволяет расширять выражения в тех местах в JavaScript, где предусмотрено использование нескольких аргументов (при вызовах функции) или ожидается несколько элементов (для массивов).
