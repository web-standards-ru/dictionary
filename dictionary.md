...
**закон тривиальности,** уделение чрезмерного внимания тривиальным вопросам, см. [Закон тривиальности](https://ru.wikipedia.org/wiki/Закон_тривиальности), напр. _avoid bikeshedding regarding the basic structure of objects - избежать закона тривиальности относительно базовой структуры объектов._
