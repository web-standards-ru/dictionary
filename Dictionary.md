...
- closure — **замыкание** - в программировании это обозначает функцию, в теле которой присутствуют ссылки на переменные, объявленные вне тела этой функции и не в качестве её параметров (а в окружающем коде). Также *closure* — [набор инструментов](https://developers.google.com/closure/‎) от Google.
- code
