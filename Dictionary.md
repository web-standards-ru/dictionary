...
- blockquote — **блочная цитата,** в гипертексте: элемент для выделения цитируемой _нестрочной_ области документа. Может содержать атрибут `cite` со ссылкой на первоисточник.
...
- progress bar — **индикатор выполнения,** элемент интерфейса, отражающий прогресс в выполнении какой-либо операции. Как правило представлен в виде постепенно заполняемой цветом геометрической фигуры.
