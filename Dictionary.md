...
Оглавление: [A](#a) [B](#b) [C](#c) [D](#d) [E](#e) [F](#f) [G](#g) [H](#h) [I](#i) J K [L](#l) [M](#m) N [O](#o) [P](#p) Q [R](#r) [S](#s) [T](#t) U [V](#v) [W](#w) X Y Z
...
- border-radius — **скругление рамки,** напр., _border-radius:3px — скругление рамки на 3 пикселя,_ см. также «скруглённые углы».
...
- margin — **внешний отступ,** напр. _margin-bottom:-10px — нижний отрицательный отступ 10 пикселей._
...
- multiple columns
	- сущ. **мультиколонки,** механизм из CSS, позволяющий выстроить текст в несколько колонок, напр. _поддержка мультиколонок в IE (multiple columns support in IE)._ Предпочтительнее, чем громоздкие «множественные колонки».
	- прил. **многоколонный,** напр. _мноколонная раскладка (multiple column layout)_
...
- padding — **внутренний отступ,** напр. _padding-top:10px — верхний внутренний отступ 10 пикселей._
- pattern — **подход,** формализованный, либо просто «хороший» или «плохой» способ написания кода, напр. _подходы к написанию JavaScript (JavaScript patterns)._
...
- preprocessor — **препроцессор,** инструмент, преобразующий код из одного синтаксиса в другой, чаще в контексте CSS напр. _CSS-препроцессор Sass._
...
- W3C — **Консорциум всемирной сети,** организация, разрабатывающая веб-стандарты. Переводить «web» как «паутину» в XXI веке уже смешно.
