...
**режим наложения,** алгоритм смешения изображений, который можно применить к слоям в Фотошопе или с помощью CSS, напр. _режим наложения перекрытием — overlay blending mode._
