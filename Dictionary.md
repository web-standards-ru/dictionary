...
2. inline box — **элемент строки** в строчном форматировани: часть наполнения контейнера строки, к которой непосредственно применяются CSS-правила, напр. _анонимный элемент строки — anonymous inline box_.
...
**режим совместимости,** режим интерпретации css, который необходим для обеспечения обратной совместимости и позволяет интерпретировать css в cоответствии с некими особенностями, присущими старым версиям браузера.
