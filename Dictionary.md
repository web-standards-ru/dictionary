...
**плотность пикселей,** количество пикселей, которое помещается в один линейный дюйм, напр. _pixel density of the new iPhone is higher than the Nexus — плотность пикселей у нового iPhone выше, чем у Nexus._

### pixel ratio

**пиксельное соотношение,** отношение физического пикселя к виртуальному, напр. _iPhone’s screen has pixel ratio of 2 — пиксельное соотношение экрана iPhone равно 2._
