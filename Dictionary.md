...
### flexbox
 ...
 - flexbox — **флексбокс** (механизм [раскладки](#layout))
 - flex container — **флекс-контейнер**
 - flex item — **флекс-элемент**
   - main axis — **главная ось**, направление, в котором флекс-элементы следуют друг за другом во флекс-контейнере
 ...
 - flex-direction — **направление главной оси** _либо ориентация главной оси_
 - flex-wrap — **перенос флекс-элементов**, определяет, является ли флекс-контейнер однострочным или многострочным
 - justify-content — **распределение флекс-элементов** по главной оси
 - align-items — **выравнивание флекс-элементов** по поперечной оси
 - align-self — **выравнивание отдельного флекс-элемента** по поперечной оси
 - align-content — **выравнивание строк** многострочного флекс-контейнера по поперечной оси
 ...
 - flex — _сокращение для `flex-basis`, `flex-grow` и `flex-shrink`_
 - flex-flow — _сокращение для `flex-direction` и `flex-wrap`_
