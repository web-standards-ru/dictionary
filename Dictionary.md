...
**выключенный, запрещенный** состояние элемента формы, в котором его взаимодействие с пользователем невозможно, напр. _запрещенная кнопка — disabled button._, _выключено по умолчанию - disabled by default_
...
**включенный, разрешенный,** состояние элемента формы, в котором возможно взаимодействие с пользователем, это сосотояние по умолчанию, напр. _разрешенная кнопка — enabled button._
