...
**плотность пикселей,** количество пикселей, которое помещается в один линейный дюйм, напр. _Pixel density of the new iPhone is higher than the Nexus — плотность пикселей у нового iPhone выше, чем у Nexus_

### pixel ratio

**пиксельное соотношение,** отношение физического пикселя к виртуальному, напр. _iPhone 4 screen has pixel ratio of 2 — пиксельное соотношение экрана iPhone 4 равно 2_
...
**разрешение,** количество физических пикселей на экране устройства, напр. _iPhone 6 screen resolution is 750x1334 — разрешение экрана iPhone 6 составляет 750x1334_
...
**валидатор,** средство проверки соответствия стандарту, спецификации или другому нормативу (см. [valid](#valid)), напр. _валидатор разметки W3C — W3C markup validator_.
