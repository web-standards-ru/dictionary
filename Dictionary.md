...
1. **точка останова,** строка в коде, на которой выполенение скрипта приостанавливается для вызова отладчика
...
**бюджет на быстродействие,** планируемые показатели быстродействия веб-приложения. Выход за рамки такого бюджета означает спад быстродействия. Напр. _Performance Budget Metrics — показатели бюджета на быстродействие._
