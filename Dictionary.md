...
- shim — **шим,** библиотека позволяющая унифицировать определенные возможности браузеров, напр. _HTML5 шим для старых IE — HTML5 shim for old IE._
...
- tab
	- **вкладка,** один из слоёв интерфейса сайта или браузера, который активируется выбором его заголовка, напр. _открыть в новой вкладке — open in new tab_
	- **таб,** клавиша табуляции, вставляет символ табуляции либо переключает фокус на следующий элемент интерфейса, напр. _нажмите контрол-таб — press Ctrl Tab._
