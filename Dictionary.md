...
**Блок стилей элемента**, состоит из селектора (или медиавыражения) и деклараций внутри него.
...
**объявление**, структурный элемент CSS. Это может быть блок стилей элемента, правило импорта, медиавыражение и т.д.
