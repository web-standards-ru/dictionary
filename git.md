...
**пулреквест,** запрос на принятие изменений из форка (см. [форк-репозиторий](#repository)) или отдельной ветки в основную ветку репозитория (см. [мастер-репозиторий](#repository)). Пулреквест может быть принят или отклонён владельцем репозитория.
